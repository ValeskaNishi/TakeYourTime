...
import clickSfx from './../../sounds/src_sounds_slide.mp3'
  ...
  return(
    <form className="controls">
      ...
      <input  type="radio" 
              ...
              onClick={playSfx} 
              onChange={handleModeChange} />
      <label htmlFor="short"  className="controls__button">Curto descanso</label>
      ...
      <input  type="radio" 
              ...
              onClick={playSfx} 
              onChange={handleModeChange} />
      <label htmlFor="long"  className="controls__button">Longo descanso</label>
    </form>
  )
}
